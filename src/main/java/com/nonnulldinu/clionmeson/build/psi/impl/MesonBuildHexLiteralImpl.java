...
public class MesonBuildHexLiteralImpl extends ASTWrapperPsiElement implements MesonBuildHexLiteral {

  public MesonBuildHexLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getHexnum() {
    return findNotNullChildByType(HEXNUM);
  }
