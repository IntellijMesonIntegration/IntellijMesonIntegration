...
public class MesonBuildParExpressionImpl extends ASTWrapperPsiElement implements MesonBuildParExpression {

  public MesonBuildParExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
