...
public class MesonBuildStringLiteralImpl extends ASTWrapperPsiElement implements MesonBuildStringLiteral {

  public MesonBuildStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
