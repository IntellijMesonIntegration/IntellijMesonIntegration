...
public class MesonBuildControlStatementImpl extends ASTWrapperPsiElement implements MesonBuildControlStatement {

  public MesonBuildControlStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
