...
public class MesonBuildIdExpressionImpl extends ASTWrapperPsiElement implements MesonBuildIdExpression {

  public MesonBuildIdExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
