...
public class MesonBuildBoolLiteralImpl extends ASTWrapperPsiElement implements MesonBuildBoolLiteral {

  public MesonBuildBoolLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
