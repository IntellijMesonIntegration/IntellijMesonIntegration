...
public class MesonBuildEqualityOpImpl extends ASTWrapperPsiElement implements MesonBuildEqualityOp {

  public MesonBuildEqualityOpImpl(@NotNull ASTNode node) {
    super(node);
  }
